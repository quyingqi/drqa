...
def add_argument():
    ...
    parser.add_argument('-channels', type=int, dest='channels', default=8)
    parser.add_argument('-conv_kernel_1', type=int, dest='conv_kernel_1', default=3)
    parser.add_argument('-conv_kernel_2', type=int, dest='conv_kernel_2', default=3)
