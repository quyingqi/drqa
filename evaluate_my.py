...
import copy
import codecs
from base.evaluate.string_tool import strQ2B, drop_punctuation, filter_blank, split_string
...
if __name__ == '__main__':
    ...
    for line in f:
        line = line.strip()
        qid, question, answer = line.split()[:3]
        answer_dict[qid] = answer
    query_acc, char_f = evalutate(answer_dict)
    print('query_acc: %.2f\tchar_f: %.2f' %(query_acc, char_f))
